...
- Make sure you save what you had for the About page in the `index.html` page. That is the default page that the browser shows when someone visits your website
